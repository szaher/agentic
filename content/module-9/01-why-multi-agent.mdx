...
quiz:
  ...
  - question: "Which real-world analogy best illustrates why multi-agent systems use a supervisor agent that delegates to specialists rather than having all agents work independently?"
    ...
    correctIndex: 1
  - question: "In Module 7, you encountered CrewAI and AutoGen as frameworks for building agent systems. How does the multi-agent paradigm taught in Module 9 extend beyond what those framework introductions covered?"
    options:
      - "Module 9 replaces CrewAI and AutoGen with newer frameworks"
      - "Module 9 focuses on the underlying principles -- orchestration topologies, communication protocols like A2A, task decomposition strategies, and consensus mechanisms -- that apply regardless of which framework you use"
      - "Module 9 only covers single-agent patterns that CrewAI cannot handle"
      - "Module 9 teaches the same content but with more code examples"
    correctIndex: 0
---
...
## Connection to Module 7: From Frameworks to Principles
