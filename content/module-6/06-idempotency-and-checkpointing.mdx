...
> **Forward to Module 12:** Checkpointing becomes critical for **long-running production agents** that operate over minutes or hours. Module 12 covers the operational infrastructure around checkpointing -- monitoring checkpoint health, alerting on stale checkpoints, cleaning up orphaned checkpoint files, and building dashboards that show agent progress across checkpoints. The pattern you learn here is the foundation; Module 12 shows how to operate it at scale.
