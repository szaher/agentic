...
This is where **memory systems** come in, which you will explore in depth in Module 7. Memory systems provide *long-term storage* that persists beyond the context window and across conversations. The context manager and memory system work together:
