...
Both orchestrators sit above the framework level because they assume you already have capable individual agents and focus on how those agents work together. You will explore multi-agent patterns in depth in Module 10.
